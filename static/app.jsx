...
function App() {
  ...
  useEffect(() => {
    fetch('/config').then((r) => r.json()).then((c) => setOutDir(c.out_dir || '')).catch(() => {});
  }, []);
      ...
      <header className="topbar">
        <div className="brand">
          ...
          <div className="brand-text">
            ...
            <div className="brand-sub mono">v0.4.2 · runs on your machine</div>
          </div>
        </div>
      ...
      <footer className="footer">
        <div className="footer-inner">
          <div className="footer-left">
            ...
            <span className="dot-sep">·</span>
            <span className="mono">yt-dlp + ffmpeg</span>
          </div>
          <div className="footer-right mono">
            <a className="footer-link" href="mailto:me@cristiangabriel.dev">
              me@cristiangabriel.dev
            </a>
            <a className="footer-link" href="https://cristiangabriel.dev" target="_blank" rel="noopener noreferrer">
              cristiangabriel.dev<span className="footer-arrow" aria-hidden>↗</span>
            </a>
          </div>
        </div>
      </footer>
